    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold font-headline animate-pulse">
            Sẵn sàng! Trò chơi sắp bắt đầu...
          </h2>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto p-4 md:p-8 flex flex-col gap-6 pb-24">
        ...
        {error && (
          <div className="bg-red-100 text-red-600 p-2 rounded-lg text-center font-bold">
            {error}
          </div>
        )}
