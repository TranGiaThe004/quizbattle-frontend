...
export default function EditQuestionModal({
  ...
  }, [initialText, initialTime, isOpen]);
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <textarea
          ...
          className="w-full bg-gray-50 p-5 rounded-2xl border-2 border-gray-200 focus:border-blue-500 focus:outline-none text-lg mb-6"
          rows={3}
        />
        <div className="flex justify-between items-center border-t-2 border-gray-100 pt-6">
          <div className="relative group flex items-center">
            ...
            <select
              ...
              className="pl-10 pr-10 py-3 bg-gray-50 border-2 rounded-xl font-bold appearance-none outline-none"
            >
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="px-6 py-3 font-bold text-gray-600 hover:bg-gray-100 rounded-xl"
            >
              Cancel
            </button>
            <button
